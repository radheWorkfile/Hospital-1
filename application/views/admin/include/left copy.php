        ...
        <nav id="sidebar" class="sidebar-wrapper">
          ...
          <div class="brand-container d-flex align-items-center justify-content-between">
            ...
            <div class="app-brand ms-3">
              <a href="index-2.html">
                <img src="assets/images/Logo.png" class="logo" alt="Medicare Admin Template">
              </a>
            </div>
            <!-- App brand ends -->
          ...
          <div class="sidebar-profile">
            <img src="assets/images/doctor6.png" class="rounded-5" alt="Hospital Admin Templates">
            <h6 class="mb-1 profile-name text-nowrap text-truncate text-primary">Noelle Kaiser</h6>
            <small class="profile-name text-nowrap text-truncate">Department Admin</small>
          </div>
            ...
            <ul class="sidebar-menu">
              <li class="active current-page">
                <a href="index-2.html">
                  ...
                  <span class="menu-text">Healthcare Admin</span>
                </a>
              </li>
              <li>
