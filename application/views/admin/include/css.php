    ...
    <link rel="stylesheet" href="<?php echo base_url();?>soft_assets/vendor/overlay-scroll/OverlayScrollbars.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>soft_assets/vendor/daterange/daterange.css">
